function [wTotal,bTotal,wcTotal,confusionMatrix,q,r_hat,var_r_hat,var_u_hat,NoA_percent] = extractSurvey(data)
...
m_ij = zeros(12,12);
m_i = zeros(1,12);
NoA_percent = zeros(12,1);

for k = 1:12
    str = ['DO-Q-q_k_', num2str(k), '_1'];
    ...
    for j = 1:13
        for i = 1:numAns
            ...
            if(~isempty(index))
                ...
                str2 = ['q_k_',num2str(k),'_1_',num2str(j)];
    ...
    NoA_percent(k,1) = wc(8,13)/wc(4,13);
